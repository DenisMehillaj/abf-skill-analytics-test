...
> [analytical answer — ending with the source link for each analytics it drew on, per §Analytical answer shape, e.g.]
> Source — [CPR](https://abf.lmi.cardoaiapps.com/transactions/dynamic-views?id=…&subviewId=…&viewId=…)
